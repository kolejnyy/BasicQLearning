...
from Game import isOver, gameScore, startState, randomState, qmove, possibleMoves, printState, drawState
...
def playout(state, player, exp_rate, debug=False):
	...
	val = reward-q_rate*playout(nextState, nextPlayer, exp_rate, debug)
